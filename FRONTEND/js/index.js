    ...
    if (arrayDatosConsulta.length===0) {
      contenedorDatos.innerHTML ="<h1 class='titulo'> No hay ninguna tarea, <b>¡¡¡espabila!!!</b> que te pilla el toro </h1>";
            ...
            for (let i = 0; i < arrayDatosConsulta.length; i++) {
              ...
              contenedorDatos.innerHTML += "<div class='indiv'><h3 class='titulo'>TAREA: " + tarea.id +"</h3>";
              contenedorDatos.innerHTML += "<h2 class='detalle'>" + tarea.descripcion + "</h2>";
              contenedorDatos.innerHTML += "<div class='row'><div class='col-25'>INICIO:</div><div class='col-75'>"+ tarea.diaInicio + "-"+ tarea.mesInicio + "-" + tarea.anoInicio + "</div></div>";
